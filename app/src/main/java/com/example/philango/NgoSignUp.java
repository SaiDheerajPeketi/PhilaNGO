        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || password.isEmpty()) {
                    Toast.makeText(NgoSignUp.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                } else {
                    databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.hasChild(email)) {
                                Toast.makeText(NgoSignUp.this, "Email is already registered", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                Toast.makeText(NgoSignUp.this, "User Registered Successfully", Toast.LENGTH_SHORT).show();
                                Intent toMainScreen = new Intent(NgoSignUp.this, mainScreen.class);
